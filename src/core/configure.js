 ...
 * @param {(Object|Function)} [configurator={}] - An object containing the
 *   configuration data to pass to the command generator, or a function which
 *   consumes the configuration produced by the generator and returns a new
 *   configuration.
